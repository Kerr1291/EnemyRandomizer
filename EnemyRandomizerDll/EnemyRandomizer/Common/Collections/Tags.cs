...
//            EditorGUILayout.PropertyField( property.FindPropertyRelative( "receivers" ), new GUIContent( "Receivers" ) );
...
//    {
//        static Tags server = new Tags( Receivers.Server );
//        static Tags serverClient = new Tags( Receivers.All );
//        public static Tags Server {  get { return server; } }
//        public static Tags ServerAndClient { get { return serverClient; } }
...
//            this.receivers = Receivers.Client;
...
//        public Tags( Receivers recievers, params string[] tags )
//        {
//            this.matching = Matching.Any;
...
//        public Tags( Matching matching, Receivers recievers, params string[] tags )
//        {
//            this.matching = matching;
//            this.receivers = recievers;
...
//            return matching + " " + receivers + " " + result.TrimEnd(',', ' ');
//        }
