...
namespace EnemyRandomizerMod.Menu
{
    ...
    /// </summary>
    public class RandomizerFauxMenuOptionHorizontal : MenuSelectable, IPointerClickHandler, IMoveHandler
    {
        void Log( string s )
        {
        ...
        public virtual void SetOptionTo(int optionNumber)
        {
            ...
            {
                Log($"{name} - Trying to select an option outside the list size (index: {optionNumber} listsize: {OptionList.Length})");
            }
        }
        ...
        protected virtual void UpdateText()
        {
            ...
            {
                Log($"{OptionText.text} : {OptionList} : {SelectedOptionIndex} {ex}");
            }
