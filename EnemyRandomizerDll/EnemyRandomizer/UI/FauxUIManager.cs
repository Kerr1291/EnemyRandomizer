...
namespace EnemyRandomizerMod.Menu
{
    ...
    /// </summary>
    internal class RandomizerFauxUIManager : MonoBehaviour
    {

        private readonly SimpleLogger _logger = new SimpleLogger("RandomizerFauxUIManager");

        private static GameManager _gm;

        internal static GameManager gameManager => _gm != null ? _gm : (_gm = GameManager.instance);

        public static RandomizerFauxUIManager Instance;
