...
namespace nv
{
    ...
    public static class SceneExtensions
    {
        ...
        public static IEnumerable<T> GetComponentsFromScene<T>(this GameObject go)
            where T : Component
        {
            return go.scene.GetComponents<T>();
        }

        public static IEnumerable<T> GetComponents<T>(this Scene scene)
            where T : Component
        {
            if (!scene.IsValid())
                return Enumerable.Empty<T>();

            return scene.GetRootGameObjects().SelectMany(x => x.GetComponentsInChildren<T>(true));
        }
