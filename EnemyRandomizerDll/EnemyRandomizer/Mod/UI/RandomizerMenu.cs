...
namespace EnemyRandomizerMod.Menu
{
    ...
    public class RandomizerMenu
    {
        ...
        {
            RandomizerMenu.rootUIManager = UIManager.instance;
        }
        ...
        void CreateMainMenuUIElements()
        {
            ...
            canvas.gameObject.GetOrAddComponent<RectTransform>().sizeDelta = new Vector2(1200f, 720f);
            CanvasScaler canvasScaler = loadingRoot.AddComponent<CanvasScaler>();
            canvasScaler.referenceResolution = new Vector2(1200f, 720f);
            //canvas.sortingOrder = 111;

            rootUIManager = UIManager.instance;
            //rootUIManager.gameObject.PrintSceneHierarchyTree();

            Vector3 pos = rootUIManager.gameObject.FindGameObjectInChildrenWithName( "StartGameButton" ).transform.position;

            loadingButton = GameObject.Instantiate(rootUIManager.gameObject.FindGameObjectInChildrenWithName( "StartGameButton" ) );
            loadingButton.transform.SetParent( rootUIManager.gameObject.FindGameObjectInChildrenWithName( "MainMenuScreen" ).transform );
            ...
            loadingButton.transform.Translate( new Vector3( -5.0f, 100f ) );
            ...
            loadingBar = GameObject.Instantiate( rootUIManager.gameObject.FindGameObjectInChildrenWithName( "StartGameButton" ) );
            loadingBar.transform.SetParent( rootUIManager.gameObject.FindGameObjectInChildrenWithName( "MainMenuScreen" ).transform );
        ...
        SmartRoutine showDatabaseUIWhenReady = new SmartRoutine();
        ...
        void ShowRandoDatabaseUI( bool show )
        {
            ...
            {
                showDatabaseUIWhenReady.UpdateBehavior = DoShowRandoDatabaseUI;
                showDatabaseUIWhenReady.Start();
            }
        }

        IEnumerator DoShowRandoDatabaseUI(params object[] args)
        {
            for (; ; )
            {
                if (loadingRoot == null)
        ...
        //    try
        //    {
        //        if( rootUIManager != null || ModType.Instance == null || ModType.GlobalSettings == null || UIManager.instance == null ) return;
        //    }
        ...
        void AddModMenuButtonToOptionMenu()
        {
            ...
            enterOptionsMenuButton.gameObject.FindGameObjectInChildrenWithName( "Text" ).GetComponent<Text>().text = "Enemy Randomizer";
            //ADD MODS TO OPTIONS MENU
        }
        ...
        void InstantiateModMenuScreenGameObject()
        {
            ...
            optionsMenuScreen.title = optionsMenuScreen.gameObject.FindGameObjectInChildrenWithName( "Title" ).GetComponent<CanvasGroup>();
            optionsMenuScreen.topFleur = optionsMenuScreen.gameObject.FindGameObjectInChildrenWithName( "TopFleur" ).GetComponent<Animator>();
            optionsMenuScreen.content = optionsMenuScreen.gameObject.FindGameObjectInChildrenWithName( "Content" ).GetComponent<CanvasGroup>();
        }
        ...
        void SetupMenuTogglePrefab()
        {
            ...
            //find it
            menuTogglePrefab = GameObject.Instantiate( rootUIManager.gameObject.FindGameObjectInChildrenWithName( "VSyncOption" ) );
        ...
        void OnCustomSeed( string seed )
        {
            ...
            EnemyRandomizer.Instance.OptionsMenuSeed = int.Parse(seed);
        ...
        //{
        //    List<string> modOptions = EnemyRandomizer.GlobalSettings.BoolValues.Select( x => x.Key ).ToList();
        ...
        //                    //EnemyRandomizer.GlobalSettings.StringValues.TryGetValue( optionName, out optionLabel );
        ...
        //                            if( optionIndex == 1 )
        //                            {
        //                                if( EnemyRandomizer.GlobalSettings.BoolValues.ContainsKey(optionName) )
        //                                    EnemyRandomizer.GlobalSettings.BoolValues[ optionName ](EnemyRandomizer.GlobalSettings,false);
        ...
        //                            {
        //                                if( EnemyRandomizer.GlobalSettings.BoolValues.ContainsKey( optionName ))
        //                                    EnemyRandomizer.GlobalSettings.BoolValues[optionName](EnemyRandomizer.GlobalSettings, true);
        ...
        //                        EnemyRandomizer.Instance.OnSaveGlobal();
        //                    };
        ...
        //                    {
        //                        menuItem.OptionList = new[] { "On", "Off" };
        //                        menuItem.SelectedOptionIndex = EnemyRandomizer.GlobalSettings.GetBoolValues[ optionName ](EnemyRandomizer.GlobalSettings) ? 0 : 1;
        //                    }
